...
const UpdatePost = () => {
  ...
  return (
    <Card sx={{ p: 4, py: 5, maxWidth: "550px", margin: "50px auto", display: "flex", flexDirection: "column", gap: 4, borderRadius: "15px" }} elevation={10}>
      ...
      <TextField  multiline id="outlined-basic" label="Content" variant="outlined" rows={3} style={{whiteSpace:"pre-wrap"}} name='content' value={blog.content} onChange={handleChange} />
